...
Use Gmsh (free online mesh generator) to generate 1D mesh. Export mesh as ".msh" in the "mesh" directory under
...
for left boundary and the second value is for the right boundary. Use -1 for wall, -2 for inlet, -3 for outlet type
boundaries.
